...
<style>
    ...
    * {
    ...
    .progress-bar.downloading {
        background: -webkit-linear-gradient(left, #11a8ab 81%, #50597b 81%);
        /* Chrome10+,Safari5.1+ */
        background: -ms-linear-gradient(left, #11a8ab 81%, #50597b 81%);
        /* IE10+ */
        background: linear-gradient(to right, #11a8ab 81%, #50597b 81%);
        /* W3C */
    }

    .progress-bar.uploading {
        background: -webkit-linear-gradient(left, #4fc4f6 43%, #50597b 43%);
        /* Chrome10+,Safari5.1+ */
        background: -ms-linear-gradient(left, #4fc4f6 43%, #50597b 43%);
        /* IE10+ */
        background: linear-gradient(to right, #4fc4f6 43%, #50597b 43%);
        /* W3C */
    }
...
<body>
    <!-- <div class="container" style="width:100%; height:150px; background-color: gray;">
        <center>
            <h2 style="padding: 30px;">This is a sample page</h2>
        </center>
        <a href="form.php?logout=true" style="float:right; margin-right:50px; font-size:24px" name="logout"> Logout</a>
    </div> -->
    <div class="main-container">
        ...
        <header class="block">
            ...
            <div class="profile-menu">
                <p>Me <a href="<?php $milktea->logout() ?>"> Log Out</span></a></p>
